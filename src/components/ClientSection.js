    ...
    <section>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 p-2 mt-10'>
          <div className='md:col-start-2'>
            <div>
              <h2 className="text-xl md:text-3xl font-heading tracking-wide font-extrabold">The Central Bank of Nigeria</h2>
              <section>
                <div></div>
              </section>
        ...
        <div className='w-full h-[2px] bg-black my-6'></div>
            ...
            <div>
              <h2 className="text-xl md:text-3xl font-heading tracking-wide font-extrabold">Titan Trust Bank</h2>
              <p class="md:text-lg text-black">Web portal Development and Brand Identity</p>
        <div className='w-full h-[2px] bg-black my-6'></div>
            </div>
            <div>
              <h2 class="text-xl md:text-3xl font-heading tracking-wide font-extrabold">The Securities and Exchange Commission (SEC)</h2>
              <p class="md:text-lg text-black">Website Redesign and Administrative Portals Development (Ongoing)</p>
        <div className='w-full h-[2px] bg-black my-6'></div>
            </div>
            <div>
              <h2 class="text-xl md:text-3xl font-heading tracking-wide font-extrabold">The Infrastructural Corporation (InfraCo)</h2>
