        ...
        <div className='mt-20 grid grid-cols-1 md:grid-cols-2 gap-x-32 gap-y-10'>
          <div>
            ...
            <div className='p-2 md:p-8'>
              <h2 className='text-2xl md:text-4xl md:leading-tight md:pr-10 font-heading tracking-wide font-black md:font-extrabold'>Technology</h2>
          ...
          <div>
            <div className='w-full h-[2px] bg-black my-4'></div>
            <div className='p-2 md:p-8'>
            <h2 className='text-2xl md:text-4xl md:leading-tight md:pr-10 font-heading tracking-wide font-black md:font-extrabold'>Data</h2>
          ...
          <div>
            <div className='w-full h-[2px] bg-black my-4'></div>
            <div className='p-2 md:p-8'>
            <h2 className='text-2xl md:text-4xl md:leading-tight md:pr-10 font-heading tracking-wide font-black md:font-extrabold'>Process</h2>
          ...
          <div>
            <div className='w-full h-[2px] bg-black my-4'></div>
            <div className='p-2 md:p-8'>
            <h2 className='text-2xl md:text-4xl md:leading-tight md:pr-10 font-heading tracking-wide font-black md:font-extrabold'>Culture</h2>
