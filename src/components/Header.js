  ...
  return (
      <header className=' bg-white md:py-4 fixed w-full z-50'>
        <div className='flex justify-between items-center max-w-[1200px] mx-auto p-6 md:w-[78%]'>
          ...
          <nav className='flex items-center gap-2' onClick={() => setIsOpen(!isOpen)}>
              <span className='font-medium cursor-pointer'>Menu</span>
        ...
        {isOpen && (
        <div className='w-screen h-screen bg-[#148F7C] fixed z-10 top-0 text-white overflow-y-scroll ' onClick={() => setIsOpen(false)}>
